...
public class StrategyDetalhesItau400
{
    ...
    public StrategyDetalhesItau400(ItauDetalhe400DTO detalhes, IUsoEmpresaService usoEmpresaService)
    {
        _d = detalhes;  
    ...
    public string Gerar()
    {
        ...
        sb.Append(_usoEmpresaService.GerarUsoEmpresa("1").PadRight(25, ' '));   // 038     062     Uso da Empresa (identificação do título)
